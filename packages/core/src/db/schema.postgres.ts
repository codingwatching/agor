...
// Create PostgreSQL-specific type helpers
...
export const sessions = pgTable(
  'sessions',
  {
    ...
    scheduled_from_worktree: t.bool('scheduled_from_worktree')
      .notNull()
      .default(false),
...
export const users = pgTable(
  'users',
  {
    ...
    // Onboarding state
    onboarding_completed: t.bool('onboarding_completed')
      .notNull()
      .default(false),
...
export const boardComments = pgTable(
  'board_comments',
  {
    ...
    reactions: t.json<unknown>('reactions')
